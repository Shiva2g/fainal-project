...
const CheckOut = () => {
  ...
  const [deliveryDate, setDeliveryDate] = useState('Not specified'); // تاریخ تحویل
    ...
    <div>
      <div className={styles.main}>
        ...
        <div className={styles.checkoutGrid}>
          ...
          <PaymentSummary shippingCost={shippingCost} deliveryDate={deliveryDate} /> {/* ارسال تاریخ تحویل */}
        </div>
      </div>
    </div>
  );
...
const PaymentSummary = ({ shippingCost, deliveryDate }) => {
  const { cart } = useCart(); 
